...
class UpdateRegistrationAlterationRequest extends FormRequest
{
    /**
    ...
    public function authorize(): bool
    {
        ...
        return $registration instanceof Registration
            ...
            && ($this->user()?->can('alterVerification', $registration) ?? false);
    }
        ...
        return [
            function (Validator $validator): void {
                ...
                if (
                    ...
                    $validator->errors()->add(
                        'receipt',
                        'Upload proof of payment before saving the alteration.',
                    );
                }
            },
        ];
