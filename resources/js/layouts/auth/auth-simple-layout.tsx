                    ...
                    <div className="w-full min-w-0">
                        <div className="overflow-hidden rounded-md border border-[#d5ddd8] bg-white/92 shadow-2xl shadow-[#184d47]/10 backdrop-blur">
                            <div className="grid lg:grid-cols-[minmax(0,0.92fr)_minmax(0,1.08fr)]">
                                <div className="min-w-0 border-b border-[#dbe5df] bg-[linear-gradient(145deg,_rgba(247,252,250,0.96),_rgba(237,245,241,0.9))] p-5 sm:p-8 lg:border-r lg:border-b-0 lg:p-10">
                                    <div className="space-y-8">
                                        ...
                                        <div className="space-y-4">
                                            ...
                                            <div className="min-w-0 space-y-3">
                                                <h1 className="max-w-xl text-3xl font-extrabold tracking-[-0.04em] text-slate-900 sm:text-4xl">
                                                    {name}
                                                </h1>
                                        ...
                                        <div className="grid auto-rows-fr gap-4">
                                            <div className="flex h-full flex-col justify-center rounded-md border border-white/80 bg-white/80 p-4 shadow-sm shadow-[#184d47]/5">
                                                ...
                                                <div className="mt-2 text-sm font-semibold text-slate-900">
                                                    Multi-level access across
                                                    district, section, and
                                                    church scopes
                                                </div>
                                            </div>
                                ...
                                >
                                    <div
                                        className={cn(
                                            'w-full',
                                            centerContent && 'mx-auto max-w-md',
                                        )}
                                    >
