...
export default function EntityRecordDialog({
    ...
    return (
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent
                className={cn(
                    '!flex max-h-[calc(100vh-1rem)] w-[calc(100vw-1rem)] !flex-col gap-0 overflow-hidden rounded-md border border-t-4 border-[#d6e2de] border-t-[#184d47] p-0 shadow-2xl shadow-[#184d47]/12 sm:max-h-[min(92vh,52rem)] sm:w-full dark:border-slate-800 dark:border-t-emerald-500',
                    maxWidthClassName,
                )}
            >
