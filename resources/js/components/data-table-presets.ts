export const elevatedIndexTableStyles = {
    ...
    selectItem:
        'rounded-md px-3 py-1.5 text-[12px] text-slate-900 sm:py-2 sm:text-[13px] focus:bg-slate-100 focus:text-slate-900 dark:text-slate-100 dark:focus:bg-slate-800 dark:focus:text-white',
    headerActions:
        'flex flex-col gap-2.5 sm:flex-row sm:items-center sm:justify-end',
    table: 'min-w-[40rem] w-full divide-y divide-slate-200/80 text-[12px] sm:min-w-full sm:text-[13px] dark:divide-slate-800',
    ...
    cell: 'py-2.5 pr-3 align-middle sm:py-3 sm:pr-3.5',
    lastCellRight: 'py-2.5 pr-4 align-middle sm:py-3 sm:pr-5',
    primaryText: 'font-medium text-slate-900 dark:text-slate-100',
    secondaryText:
        'mt-1 text-[12px] text-slate-500 sm:text-[13px] dark:text-slate-400',
    detailText:
        'mt-1.5 max-w-xl text-[12px] leading-5 text-slate-500 sm:mt-2 sm:text-[13px] dark:text-slate-400',
    metaText:
        'mt-1.5 text-[10px] font-semibold tracking-[0.14em] uppercase text-slate-500 sm:mt-2 sm:text-[11px] sm:tracking-[0.16em] dark:text-slate-400',
    subMetaText:
        'mt-1 text-[10px] font-semibold tracking-[0.14em] uppercase text-slate-500 sm:text-[11px] sm:tracking-[0.16em] dark:text-slate-400',
    strongText: 'font-medium text-slate-900 dark:text-slate-100',
    metricText: 'text-[12px] text-slate-500 sm:text-[13px] dark:text-slate-400',
    inlineTag:
        'inline-flex rounded-md bg-slate-100 px-2 py-1 text-[10px] font-semibold tracking-[0.12em] uppercase text-slate-600 sm:px-2.5 sm:text-[11px] sm:tracking-[0.14em] dark:bg-slate-800 dark:text-slate-200',
    subtleSurface:
        'rounded-md border border-slate-200/80 bg-white px-2.5 py-1.5 dark:border-slate-800 dark:bg-slate-950',
    actionGroup: 'flex justify-end gap-2',
    emptyCell: 'px-4 py-10 text-center sm:px-5 sm:py-12',
    emptyTitle:
        'text-[13px] font-medium text-slate-900 sm:text-sm dark:text-slate-100',
    emptyDescription:
        'text-[12px] text-slate-500 sm:text-[13px] dark:text-slate-400',
    paginationWrapper:
        'border-t border-slate-200/80 bg-slate-50/80 px-3 py-2.5 sm:px-4 sm:py-3 md:px-5 dark:border-slate-800 dark:bg-slate-950/70',
    pagination: 'gap-3 border-none pt-0',
    paginationTopRow: 'gap-3 sm:items-center',
    rowsTrigger:
        'h-8 w-[6rem] rounded-md border-slate-200 bg-white text-[12px] text-slate-700 shadow-none sm:h-9 sm:w-[6.75rem] sm:text-[13px] dark:border-slate-800 dark:bg-slate-950 dark:text-slate-100',
    summary:
        'text-[12px] font-medium text-slate-600 sm:text-[13px] dark:text-slate-300',
    navigationWrapper: 'border-t border-slate-200 pt-3 dark:border-slate-800',
    previousButton:
        'h-7 rounded-md border-slate-200 bg-white px-2.5 text-[12px] text-slate-700 hover:bg-slate-100 sm:h-8 sm:px-3 sm:text-[13px] dark:border-slate-800 dark:bg-slate-950 dark:text-slate-100 dark:hover:bg-slate-900',
    nextButton:
        'h-7 rounded-md border-slate-200 bg-white px-2.5 text-[12px] text-slate-700 hover:bg-slate-100 sm:h-8 sm:px-3 sm:text-[13px] dark:border-slate-800 dark:bg-slate-950 dark:text-slate-100 dark:hover:bg-slate-900',
    activePageButton:
        'h-7 rounded-md border-[#184d47] bg-[#184d47] text-[12px] text-white hover:bg-[#143f3a] sm:h-8 sm:text-[13px]',
    inactivePageButton:
        'h-7 rounded-md border-slate-200 bg-white text-[12px] text-slate-700 hover:bg-slate-100 sm:h-8 sm:text-[13px] dark:border-slate-800 dark:bg-slate-950 dark:text-slate-100 dark:hover:bg-slate-900',
    ellipsis: 'h-7 rounded-md text-slate-400 sm:h-8 dark:text-slate-500',
} as const;

export const reviewWorkspaceStyles = {
    summaryCard:
        'rounded-md border px-4 py-3.5 shadow-sm transition-colors sm:px-5 sm:py-4',
    summaryCardPending:
    ...
    flashSuccess:
        'rounded-md border border-emerald-200 bg-emerald-50 px-4 py-2.5 text-[13px] text-emerald-900 dark:border-emerald-800 dark:bg-emerald-950/70 dark:text-emerald-100',
    flashError:
        'rounded-md border border-rose-200 bg-rose-50 px-4 py-2.5 text-[13px] text-rose-700 dark:border-rose-900 dark:bg-rose-950/70 dark:text-rose-100',
    ...
    action: 'w-full lg:w-auto',
    selectTrigger:
        'h-9 w-full rounded-md border-[#d6e2de] bg-white px-3 text-[12px] text-slate-700 shadow-none data-[placeholder]:text-slate-400 sm:h-10 sm:min-w-48 sm:px-3.5 sm:text-[13px] focus-visible:border-[#184d47]/35 focus-visible:ring-[#184d47]/12 dark:border-slate-800 dark:bg-slate-950 dark:text-slate-100 dark:data-[placeholder]:text-slate-500',
    selectContent:
    ...
    paginationTopRow: 'gap-3 sm:items-center',
    rowsTrigger:
        'h-8 w-[6rem] rounded-md border-[#d6e2de] bg-white text-[12px] text-slate-700 shadow-none sm:h-9 sm:w-[6.75rem] sm:text-[13px] dark:border-slate-800 dark:bg-slate-950 dark:text-slate-100',
    summary:
        'text-[12px] font-medium text-slate-600 sm:text-[13px] dark:text-slate-300',
    navigationWrapper: 'border-t border-[#dce4e1] pt-3 dark:border-slate-800',
    previousButton:
        'h-7 rounded-md border-[#d6e2de] bg-white px-2.5 text-[12px] text-slate-700 hover:bg-slate-100 sm:h-8 sm:px-3 sm:text-[13px] dark:border-slate-800 dark:bg-slate-950 dark:text-slate-100 dark:hover:bg-slate-900',
    nextButton:
        'h-7 rounded-md border-[#d6e2de] bg-white px-2.5 text-[12px] text-slate-700 hover:bg-slate-100 sm:h-8 sm:px-3 sm:text-[13px] dark:border-slate-800 dark:bg-slate-950 dark:text-slate-100 dark:hover:bg-slate-900',
    activePageButton:
        'h-7 rounded-md border-[#184d47] bg-[#184d47] text-[12px] text-white hover:bg-[#143f3a] sm:h-8 sm:text-[13px]',
    inactivePageButton:
        'h-7 rounded-md border-[#d6e2de] bg-white text-[12px] text-slate-700 hover:bg-slate-100 sm:h-8 sm:text-[13px] dark:border-slate-800 dark:bg-slate-950 dark:text-slate-100 dark:hover:bg-slate-900',
    ellipsis: 'h-7 rounded-md text-slate-400 sm:h-8 dark:text-slate-500',
} as const;
